Public Class jeuxMot3
    Dim m_MouseIsDown As Boolean
    Dim sender2 As Object
    Dim b11 As Image = My.Resources.b11 'imported from a file called Swamp.jpg
    Dim b12 As Image = My.Resources.b12 'Imported from a file called Dusty.jpg
    Dim b13 As Image = My.Resources.b13 'Imported from a file called Dusty.jpg
    Dim b14 As Image = My.Resources.b14 'Imported from a file called Dusty.jpg
    Dim b15 As Image = My.Resources.b15 'Imported from a file called Dusty.jpg
    Dim pt As Integer 
...
#Region "DragDrop"
    ...
    Private Sub btnSubmit_Click(sender As Object, e As EventArgs) Handles btnSubmit.Click
        ...
        Dim rs1 As Boolean = AreSameImage(r1.Image, b11)
        Dim rs2 As Boolean = AreSameImage(r2.Image, b12)
        Dim rs3 As Boolean = AreSameImage(r3.Image, b13)
        Dim rs4 As Boolean = AreSameImage(r4.Image, b14)
        Dim rs5 As Boolean = AreSameImage(r5.Image, b15)
        ...
        End If
        lblResult.Text=pt 
        GlobalVariable.Note=GlobalVariable.Note+pt 
        pt=0
    End Sub
