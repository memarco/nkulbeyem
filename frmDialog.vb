Public Class frmDialog
    ...
    Private Sub PictureBox2_Click(sender As Object, e As EventArgs) Handles PictureBox2.Click
        PresentationReligion.Show()
        mpProf.URL = My.Computer.FileSystem.CurrentDirectory + "\audio\13DIALOGUE\religion.mp3"
        mpProf.Ctlcontrols.play()
        DurationTimer.Enabled = True
    End Sub

    Private Sub PictureBox7_Click_1(sender As Object, e As EventArgs) Handles PictureBox7.Click
        PresentationLangue.Show()
        mpProf.URL = My.Computer.FileSystem.CurrentDirectory + "\audio\13DIALOGUE\langue.mp3"
        mpProf.Ctlcontrols.play()
        DurationTimer.Enabled = True
    End Sub
