Public Class jeuxMot2
    Dim m_MouseIsDown As Boolean
    Dim sender2 As Object
    Dim b6 As Image = My.Resources.b6 'imported from a file called Swamp.jpg
    Dim b7 As Image = My.Resources.b7 'Imported from a file called Dusty.jpg
    Dim b8 As Image = My.Resources.b8 'Imported from a file called Dusty.jpg
    Dim b9 As Image = My.Resources.b9 'Imported from a file called Dusty.jpg
    Dim b10 As Image = My.Resources.b10 'Imported from a file called Dusty.jpg
    Dim pt As Integer 
...
#Region "DragDrop"
    ...
    Private Sub btnSubmit_Click(sender As Object, e As EventArgs) Handles btnSubmit.Click
        ...
        Dim rs1 As Boolean = AreSameImage(r1.Image, b6)
        Dim rs2 As Boolean = AreSameImage(r2.Image, b7)
        Dim rs3 As Boolean = AreSameImage(r3.Image, b8)
        Dim rs4 As Boolean = AreSameImage(r4.Image, b9)
        Dim rs5 As Boolean = AreSameImage(r5.Image, b10)
