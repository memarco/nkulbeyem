Public Class dictMoisJour
    ...
    Private Sub PictureBox29_Click(sender As Object, e As EventArgs) Handles PictureBox29.Click 
        DurationTimer.Enabled = True
        mpProf.URL = My.Computer.FileSystem.CurrentDirectory + "\audio\dictionnary\moisjour\JANVIER.wav"
        mpProf.Ctlcontrols.play()
    End Sub

    Private Sub PictureBox3_Click_2(sender As Object, e As EventArgs)  
        DurationTimer.Enabled = True
        mpProf.URL = My.Computer.FileSystem.CurrentDirectory + "\audio\dictionnary\moisjour\15H.wav"
        mpProf.Ctlcontrols.play()
    End Sub

    Private Sub PictureBox5_Click_1(sender As Object, e As EventArgs) 
        DurationTimer.Enabled = True
        mpProf.URL = My.Computer.FileSystem.CurrentDirectory + "\audio\dictionnary\moisjour\20H.wav"
        mpProf.Ctlcontrols.play()
    ...
    Private Sub PictureBox6_Click_1(sender As Object, e As EventArgs) 
        DurationTimer.Enabled = True
        mpProf.URL = My.Computer.FileSystem.CurrentDirectory + "\audio\dictionnary\moisjour\MIDI.wav"
        mpProf.Ctlcontrols.play()
    End Sub

    Private Sub PictureBox7_Click_1(sender As Object, e As EventArgs) 
        DurationTimer.Enabled = True
        mpProf.URL = My.Computer.FileSystem.CurrentDirectory + "\audio\dictionnary\moisjour\HEURE.wav"
        mpProf.Ctlcontrols.play()
    ...
    Private Sub PictureBox8_Click_1(sender As Object, e As EventArgs) 
        DurationTimer.Enabled = True
        mpProf.URL = My.Computer.FileSystem.CurrentDirectory + "\audio\dictionnary\moisjour\MINUIT.wav"
        mpProf.Ctlcontrols.play()
    ...
    Private Sub PictureBox9_Click_1(sender As Object, e As EventArgs) 
        DurationTimer.Enabled = True
        mpProf.URL = My.Computer.FileSystem.CurrentDirectory + "\audio\dictionnary\moisjour\LA NUIT.wav"
        mpProf.Ctlcontrols.play()
    ...
    Private Sub PictureBox10_Click_1(sender As Object, e As EventArgs) 
        DurationTimer.Enabled = True
        mpProf.URL = My.Computer.FileSystem.CurrentDirectory + "\audio\dictionnary\moisjour\LE MATIN.wav"
        mpProf.Ctlcontrols.play()
    ...
    Private Sub PictureBox11_Click_1(sender As Object, e As EventArgs) 
        DurationTimer.Enabled = True
        mpProf.URL = My.Computer.FileSystem.CurrentDirectory + "\audio\dictionnary\moisjour\LE SOIR.wav"
        mpProf.Ctlcontrols.play()

    End Sub

    Private Sub PictureBox3_Click_3(sender As Object, e As EventArgs) Handles PictureBox3.Click
        DurationTimer.Enabled = True
        mpProf.URL = My.Computer.FileSystem.CurrentDirectory + "\audio\dictionnary\moisjour\FEVRIER.wav"
        mpProf.Ctlcontrols.play()
    ...
    Private Sub PictureBox6_Click_2(sender As Object, e As EventArgs) Handles PictureBox6.Click
        DurationTimer.Enabled = True
        mpProf.URL = My.Computer.FileSystem.CurrentDirectory + "\audio\dictionnary\moisjour\MARS.wav"
        mpProf.Ctlcontrols.play()
    ...
    Private Sub PictureBox13_Click_2(sender As Object, e As EventArgs) Handles PictureBox13.Click
        DurationTimer.Enabled = True
        mpProf.URL = My.Computer.FileSystem.CurrentDirectory + "\audio\dictionnary\moisjour\AVRIL.wav"
        mpProf.Ctlcontrols.play()
    ...
    Private Sub PictureBox12_Click_1(sender As Object, e As EventArgs) Handles PictureBox12.Click
        DurationTimer.Enabled = True
        mpProf.URL = My.Computer.FileSystem.CurrentDirectory + "\audio\dictionnary\moisjour\MAI.wav"
        mpProf.Ctlcontrols.play()
    ...
    Private Sub PictureBox7_Click_2(sender As Object, e As EventArgs) Handles PictureBox7.Click
        DurationTimer.Enabled = True
        mpProf.URL = My.Computer.FileSystem.CurrentDirectory + "\audio\dictionnary\moisjour\JUIN.wav"
        mpProf.Ctlcontrols.play()
    ...
    Private Sub PictureBox15_Click_1(sender As Object, e As EventArgs) Handles PictureBox15.Click
        DurationTimer.Enabled = True
        mpProf.URL = My.Computer.FileSystem.CurrentDirectory + "\audio\dictionnary\moisjour\JUILLET.wav"
        mpProf.Ctlcontrols.play()
    ...
    Private Sub PictureBox14_Click_1(sender As Object, e As EventArgs) Handles PictureBox14.Click
        DurationTimer.Enabled = True
        mpProf.URL = My.Computer.FileSystem.CurrentDirectory + "\audio\dictionnary\moisjour\AOUT.wav"
        mpProf.Ctlcontrols.play()
    ...
    Private Sub PictureBox23_Click_1(sender As Object, e As EventArgs) Handles PictureBox23.Click
        DurationTimer.Enabled = True
        mpProf.URL = My.Computer.FileSystem.CurrentDirectory + "\audio\dictionnary\moisjour\SEPTEMBRE.wav"
        mpProf.Ctlcontrols.play()
    ...
    Private Sub PictureBox22_Click_1(sender As Object, e As EventArgs) Handles PictureBox22.Click
        DurationTimer.Enabled = True
        mpProf.URL = My.Computer.FileSystem.CurrentDirectory + "\audio\dictionnary\moisjour\OCTOBRE.wav"
        mpProf.Ctlcontrols.play()
    ...
    Private Sub PictureBox9_Click_2(sender As Object, e As EventArgs) Handles PictureBox9.Click
        DurationTimer.Enabled = True
        mpProf.URL = My.Computer.FileSystem.CurrentDirectory + "\audio\dictionnary\moisjour\NOVEMBRE.wav"
        mpProf.Ctlcontrols.play()
    ...
    Private Sub PictureBox5_Click_2(sender As Object, e As EventArgs) Handles PictureBox5.Click 
        DurationTimer.Enabled = True
        mpProf.URL = My.Computer.FileSystem.CurrentDirectory + "\audio\dictionnary\moisjour\DECEMBRE.wav"
        mpProf.Ctlcontrols.play()
    ...
    Private Sub PictureBox21_Click_1(sender As Object, e As EventArgs) Handles PictureBox21.Click
        ...
        DurationTimer.Enabled = True
        mpProf.URL = My.Computer.FileSystem.CurrentDirectory + "\audio\dictionnary\moisjour\LUNDI.wav"
        mpProf.Ctlcontrols.play()
    ...
    Private Sub PictureBox20_Click_1(sender As Object, e As EventArgs) Handles PictureBox20.Click
        ...
        DurationTimer.Enabled = True
        mpProf.URL = My.Computer.FileSystem.CurrentDirectory + "\audio\dictionnary\moisjour\MARDI.wav"
        mpProf.Ctlcontrols.play()
    ...
    Private Sub PictureBox19_Click_1(sender As Object, e As EventArgs) Handles PictureBox19.Click
        DurationTimer.Enabled = True
        mpProf.URL = My.Computer.FileSystem.CurrentDirectory + "\audio\dictionnary\moisjour\MERCREDI.wav"
        mpProf.Ctlcontrols.play()
    ...
    Private Sub PictureBox18_Click_1(sender As Object, e As EventArgs) Handles PictureBox18.Click
        ...
        DurationTimer.Enabled = True
        mpProf.URL = My.Computer.FileSystem.CurrentDirectory + "\audio\dictionnary\moisjour\JEUDI.wav"
        mpProf.Ctlcontrols.play()
    ...
    Private Sub PictureBox17_Click_1(sender As Object, e As EventArgs) Handles PictureBox17.Click
        DurationTimer.Enabled = True
        mpProf.URL = My.Computer.FileSystem.CurrentDirectory + "\audio\dictionnary\moisjour\VENDREDI.wav"
        mpProf.Ctlcontrols.play()
    ...
    Private Sub PictureBox16_Click_1(sender As Object, e As EventArgs) Handles PictureBox16.Click
        ...
        DurationTimer.Enabled = True
        mpProf.URL = My.Computer.FileSystem.CurrentDirectory + "\audio\dictionnary\moisjour\SAMEDI.wav"
        mpProf.Ctlcontrols.play()

    End Sub

    Private Sub PictureBox8_Click_2(sender As Object, e As EventArgs) Handles PictureBox8.Click
        
        DurationTimer.Enabled = True
        mpProf.URL = My.Computer.FileSystem.CurrentDirectory + "\audio\dictionnary\moisjour\DIMENCHE.wav"
        mpProf.Ctlcontrols.play()
    End Sub
End Class